...
namespace cetys.APIs.Escolar
{
    ...
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "APIs.Escolar v2 - Informacion de Escolar");
        ...
        /// <summary>
        /// Returns the path where tha .xml file is autogenerated during build
        /// </summary>
        /// <returns></returns>
        protected static string GetXmlCommentsPath()
        {
            //Determine base path for the application.
            //var basePath = AppContext.BaseDirectory + "App_Data\\";
